    ...
    std::generate(returnedValue.begin(), returnedValue.end(), [&index]
            {
                ...
                app_req.task_id().iteration_id(1);
    ...
    std::generate(returnedValue.begin(), returnedValue.end(), [&index]
            {
                ...
                enc_task.task_id().iteration_id(1);
    ...
    std::generate(returnedValue.begin(), returnedValue.end(), [&index]
            {
                ...
                ml_model.task_id().iteration_id(1);
                std::stringstream ss;
